...
const RadialVelocityMethod = () => {
    ...
    return (
        <div className="font-Saira absolute top-0 mx-60 mt-20">
            ...
            <div className="-z-10 absolute right-0 w-full h-96 overflow-hidden flex justify-end items-center">
            ...
            <div className="border-2 mb-10 rounded-xl p-3 border-opacity-10 border-gray-300 bg-gray-700 bg-opacity-30">
                <details className="collapse">
                    <summary className="pl-10 collapse-title"><StrongText text="How the Radial Velocity (Doppler) Method Works:" /></summary>
                    <Para text1="Gravitational Influence of Planets:" text2="A star and its planet both orbit a common center of mass. Though the star is far more massive than the planet, the planet still exerts a small gravitational pull on the star, causing the star to 'wobble' slightly as it moves around the center of mass. This wobbling motion is small and periodic, but it can be detected by monitoring the light from the star." />
                    <Para text1="Doppler Effect:" text2="As the star moves toward Earth (due to the gravitational influence of an orbiting planet), its light becomes slightly blue-shifted (wavelengths shorten). When the star moves away from Earth, its light becomes slightly red-shifted (wavelengths lengthen). This change in wavelength of the star's light, known as the Doppler Effect, can be detected with very sensitive spectrographs. By measuring these shifts in the star’s spectral lines, scientists can infer the velocity of the star along the line of sight (this is known as the radial velocity of the star)." />
                    <Para text1="Periodic Velocity Changes:" text2="If a planet is present, these shifts in wavelength will occur regularly as the star moves in response to the planet’s gravitational pull. By tracking this periodic motion, astronomers can determine important details about the planet, such as its mass and orbit. A typical radial velocity signal shows the star moving toward and away from us in a smooth and regular pattern over time, indicating a companion planet in orbit around it." />
                </details>
            </div>
            ...
            <div className="border-2 mb-10 rounded-xl p-3 border-opacity-10 border-gray-300 bg-gray-700 bg-opacity-30">
                <details className="collapse">
                    <summary className="pl-10 collapse-title"><StrongText text="Planetary Properties from Radial Velocity Method:" /></summary>
                    <Para text1="Planet’s Mass:" text2="The amplitude of the radial velocity signal (the extent of the wavelength shifts) is related to the mass of the planet. A more massive planet will exert a stronger gravitational pull on the star, leading to a larger amplitude in the radial velocity signal. However, the radial velocity method only provides a minimum mass of the planet, because it cannot directly measure the inclination of the planet’s orbit. If the orbit is not edge-on relative to Earth, the true mass of the planet could be higher than what is measured." />
            ...
            <div className="border-2 mb-10 rounded-xl p-3 border-opacity-10 border-gray-300 bg-gray-700 bg-opacity-30">
                <details className="collapse">
                    <summary className="pl-10 collapse-title"><StrongText text="Strengths of the Radial Velocity Method:" /></summary>
            ...
            <div className="border-2 mb-10 rounded-xl p-3 border-opacity-10 border-gray-300 bg-gray-700 bg-opacity-30">
                <details className="collapse">
                    <summary className="pl-10 collapse-title"><StrongText text="Limitations of the Radial Velocity Method:" /></summary>
            ...
            <div className="border-2 mb-10 rounded-xl p-3 border-opacity-10 border-gray-300 bg-gray-700 bg-opacity-30">
                <details className="collapse">
                    <summary className="pl-10 collapse-title"><StrongText text="Instruments and Missions Using the Radial Velocity Method:" /></summary>
                    <Para text1="HARPS (High Accuracy Radial velocity Planet Searcher):" text2="HARPS is one of the most well-known instruments using the radial velocity method. It is mounted on the 3.6-meter telescope at La Silla Observatory in Chile and is capable of detecting very small changes in a star’s velocity, down to a precision of about 1 meter per second. HARPS has been responsible for the discovery of many exoplanets, particularly in multi-planet systems." />
            ...
            <div className="border-2 mb-10 rounded-xl p-3 border-opacity-10 border-gray-300 bg-gray-700 bg-opacity-30">
                <details className="collapse">
                    <summary className="pl-10 collapse-title"><StrongText text="Examples of Planets Discovered Using the Radial Velocity Method:" /></summary>
