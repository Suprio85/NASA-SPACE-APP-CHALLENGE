...
import TransitMethod1 from "../../assets/Images/gm.jpeg";
import TransitMethod2 from "../../assets/Images/m2.jpeg";
...
const GravitationalMicroLensing = () => {
    ...
    return (
        <div className="font-Saira absolute top-0 mx-60 mt-20">
            ...
            {/* Collapsing Sections using details-summary structure */}
            <div className="border-2 mb-10 rounded-xl p-3 border-opacity-10 border-gray-300 bg-gray-700 bg-opacity-30">
                <details className="collapse">
                    <summary className="pl-10 collapse-title"><StrongText text="How Gravitational Microlensing Works:" /></summary>
                    <Para text1="Gravitational Lensing:" text2="When a massive object, such as a star or planet, passes in front of a more distant background star from the observer's perspective, the gravitational field of the foreground object (called the lens star) bends and magnifies the light from the background star (called the source star). This is known as gravitational lensing. This bending of light causes the distant star to momentarily appear brighter as the alignment between the lens star and the source star changes." />
                    <Para text1="Microlensing Events:" text2="When the alignment between the observer, the lens star, and the source star is nearly perfect, the light from the source star is bent into a ring-like shape, called an Einstein Ring. In most cases, however, the alignment is not perfect, and instead of a ring, observers see two distorted images of the background star, though they are too close together to resolve separately. What is observed is a brief, sharp increase in brightness, called a microlensing event." />
                    <Para text1="Planetary Detection:" text2="If the lens star has an orbiting planet, the planet’s gravity adds additional distortion to the lensing effect. This causes detectable anomalies in the light curve (the graph of brightness over time). These anomalies can be used to infer the presence of a planet orbiting the lens star. The anomaly produced by the planet lasts for a very short period (hours to days) compared to the overall lensing event (weeks to months)." />
                    <Para text1="No Need for Light from the Planet or Star:" text2="One of the key aspects of the microlensing method is that it doesn’t require direct detection of light from the planet or even the lens star. It only depends on the gravitational effects on the light of a more distant background star. This makes microlensing particularly useful for detecting planets that are farther from their stars or are located in very distant systems, even in the center of the galaxy." />
                </details>
            </div>
            ...
            <div className="border-2 mb-10 rounded-xl p-3 border-opacity-10 border-gray-300 bg-gray-700 bg-opacity-30">
                <details className="collapse">
                    <summary className="pl-10 collapse-title"><StrongText text="What is Detected During a Microlensing Event:" /></summary>
            ...
            <div className="border-2 mb-10 rounded-xl p-3 border-opacity-10 border-gray-300 bg-gray-700 bg-opacity-30">
                <details className="collapse">
                    <summary className="pl-10 collapse-title"><StrongText text="Strengths of Gravitational Microlensing:" /></summary>
            ...
            <div className="border-2 mb-10 rounded-xl p-3 border-opacity-10 border-gray-300 bg-gray-700 bg-opacity-30">
                <details className="collapse">
                    <summary className="pl-10 collapse-title"><StrongText text="Limitations of Gravitational Microlensing:" /></summary>
                    <Para text1="One-Time Events:" text2="Microlensing events are one-time occurrences. Once the lens star and source star move out of alignment, the microlensing event is over and cannot be repeated. This means that microlensing detections are time-sensitive, and astronomers must catch the event as it happens. After the event, the planets detected cannot usually be observed again through microlensing. Follow-up observations using other methods are often not possible, especially for very distant systems." />
                    <Para text1="Rare and Unpredictable:" text2="Microlensing events are relatively rare because they depend on a chance alignment of a distant star and a lensing star. These events are difficult to predict, and astronomers must continuously monitor large fields of stars to catch a microlensing event in action. Surveys like OGLE (Optical Gravitational Lensing Experiment) and MOA (Microlensing Observations in Astrophysics) monitor millions of stars regularly to catch these rare events." />
                    <Para text1="Limited Information About Planetary Systems:" text2="While microlensing is great at detecting planets, it provides less information about the detected planet compared to other methods. For example, microlensing does not provide direct information about the planet’s size or atmospheric composition. It only provides an estimate of the planet’s mass and its distance from the host star. Additionally, since microlensing only detects the gravitational influence of a planet during a brief event, it can be difficult to confirm whether the detected planet is truly bound to the host star or if it is a free-floating planet." />
                </details>
            </div>

            <div className="border-2 mb-10 rounded-xl p-3 border-opacity-10 border-gray-300 bg-gray-700 bg-opacity-30">
                <details className="collapse">
                    <summary className="pl-10 collapse-title"><StrongText text="Instruments and Projects Using Gravitational Microlensing:" /></summary>
            ...
            <div className="border-2 mb-10 rounded-xl p-3 border-opacity-10 border-gray-300 bg-gray-700 bg-opacity-30">
                <details className="collapse">
                    <summary className="pl-10 collapse-title"><StrongText text="Examples of Planets Discovered Using Microlensing:" /></summary>
