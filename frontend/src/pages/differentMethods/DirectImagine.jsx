    ...
    return (
        <div className="font-Saira absolute top-0 mx-60 mt-20">
            ...
            <div className="mb-20 h-96">
                ...
                <div className="mt-10" onClick={handleSimulation}><Button text="Simulate Direct Imaging" /></div>
            </div>
            ...
            <div className="border-2 mb-10 rounded-xl p-3 border-opacity-10 border-gray-300 bg-gray-700 bg-opacity-30">
                <details className="collapse">
                    <summary className="pl-10 collapse-title"><StrongText text="How Direct Imaging Works:" /></summary>
            ...
            <div className="border-2 mb-10 rounded-xl p-3 border-opacity-10 border-gray-300 bg-gray-700 bg-opacity-30">
                <details className="collapse">
                    <summary className="pl-10 collapse-title"><StrongText text="Strengths of Direct Imaging:" /></summary>
            ...
            <div className="border-2 mb-10 rounded-xl p-3 border-opacity-10 border-gray-300 bg-gray-700 bg-opacity-30">
                <details className="collapse">
                    <summary className="pl-10 collapse-title"><StrongText text="Limitations of Direct Imaging:" /></summary>
            ...
            <div className="border-2 mb-10 rounded-xl p-3 border-opacity-10 border-gray-300 bg-gray-700 bg-opacity-30">
                <details className="collapse">
                    <summary className="pl-10 collapse-title"><StrongText text="Instruments and Projects Using Direct Imaging:" /></summary>
            ...
            <div className="border-2 mb-10 rounded-xl p-3 border-opacity-10 border-gray-300 bg-gray-700 bg-opacity-30">
                <details className="collapse">
                    <summary className="pl-10 collapse-title"><StrongText text="Examples of Planets Discovered via Direct Imaging:" /></summary>
