...
const drawRadarChart = (name) => {
  ...
  return (
          <div className="row flex flex-wrap justify-normal text-center">
            <div className="col col-xl-8 w-2/3  shadow-md bg-slate-200">
              <div className="card shadow mb-4">
                <div className="card-header text-center bg-gray-400">
                  <h6 className="fw-bold m-0 text-center text-black">
                    <label htmlFor="planet_year">Planets discovered in</label>
                    <select className='bg-gray-400' id="planet_year" value={selectedYear} onChange={handleYearChange}>
                ...
                <div ref={bubbleDivRef} id="bubble_div"></div>
                <div ref={tooltipRef} className="tooltip"></div>
              </div>
            </div>
            <div className="col-lg-4 col-xl-4 bg-slate-200 w-1/3  shadow-lg">
              <div className="card shadow mb-4">
                <div className="card-header text-center bg-gray-400">
                  <h6 className="fw-bold m-0 text-center text-black">
                ...
                <div className="card-body w-full" id="side_graph">
                  <div ref={radarDivRef} id="radar_div"></div>
                </div>
              </div>
            </div>
          </div>
