...
const JourneyWithorbit = () => {
    ...
    return (
        <dib className="absolute top-0 h-screen w-full">
            ...
            <div className=" flex flex-col justify-center  items-center mx-60 text-xl text-white font-Saira h-screen">
                <div className=" flex justify-center items-center">Hey there, space explorers! I’m <div className="w-28"><OrbitName /></div>,</div>
