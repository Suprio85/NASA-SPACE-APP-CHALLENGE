...
const ExoplanetCard = ({ planet }) => {
    ...
    return (
        <div className="bg-gray-800 overflow-hidden relative rounded-lg p-6 shadow-lg -z-10 mb-5">
            ...
            <div className='absolute overflow-hidden -left-20 -bottom-32 -z-10 opacity-50'>
...
const SmallBox = ({ label, value }) => {
    return (
        <div className='my-2  h-20 flex justify-center items-center flex-col bg-slate-700 rounded-md'>
            <div className='text-sm h-2/3  w-full flex justify-center items-center text-2xl'>{value}</div>
            <div className='font-bold h-1/3 w-full flex justify-center items-center bg-slate-600 bg-opacity-90 rounded-bl-md rounded-br-md'>{label}</div>
        </div>
    );
};
