    ...
    return (
        <div className="hero w-full h-screen  flex items-center overflow-hidden relative">
            <div className='pl-36'>
                ...
                <div>
                    <button className='btn overflow-hidden relative'>
                        <div className='z-10 text-black font-spaceGrotesk'>Discover Now</div>
                        <img src={planet3} alt="planet3" className=" absolute inline-block ml-2" />
                    </button>
                </div>
            </div>
