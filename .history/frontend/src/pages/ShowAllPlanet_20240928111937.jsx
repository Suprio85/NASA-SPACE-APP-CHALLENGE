...
const SmallBox = ({ label, value }) => {
    return (
        <div className='my-2  h-20 flex justify-center items-center flex-col bg-slate-700 bg-opacity-50 rounded-md'>
            ...
            <div className='font-mediuem h-1/3 w-full flex justify-center items-center font-Titiliuam bg-slate-600 bg-opacity-50 rounded-bl-md rounded-br-md'>{label}</div>
        </div>
    );
};
