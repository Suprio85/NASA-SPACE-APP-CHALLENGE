    ...
    return (
        <div className="bg-gray-800 bg-opacity-35 overflow-hidden h-96 relative rounded-lg p-6 shadow-lg mb-5">
            <div className='absolute flex justify-center items-center top-10 left-10'>
                ...
                <div className='rounded-full border-white border-2  absolute -z-10' style={{height:'940px ',width:'940px'}}></div>
                ...
                <div className='rounded-full border-white border-2  absolute -z-10' style={{height:'1540px ',width:'1540px'}}></div>
                <div className='rounded-full border-white border-2  absolute -z-10' style={{height:'1740px ',width:'1740px'}}></div>
            </div>
