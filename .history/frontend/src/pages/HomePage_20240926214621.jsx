    ...
    return (
        <div className="hero w-full h-screen  flex items-center overflow-hidden relative">
            <div className='pl-36'>
                ...
                <div>
                    <button className='btn btn- overflow-hidden relative'>
                        <div className='z-10 text-black font-spaceGrotesk text-xl'>Discover Now</div>
                        <img src={planet3} alt="planet3" className="-top-5 absolute w-96 ml-3" />
                    </button>
                </div>
            </div>
