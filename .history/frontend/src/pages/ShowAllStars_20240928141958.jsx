...
const StarPlanetPage = () => {
    ...
    return (
        <div className="min-h-screen absolute top-0 text-white w-full ">
            ...
            <div>
                <Chapter title="Star Explorer" story="Explore the stars and their planets in the galaxy. Search for your favorite star and discover its planets." image={char1} dir="rtl" />
            </div>
