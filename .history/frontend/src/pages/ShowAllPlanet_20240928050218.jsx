...
const EXOPLANET_API_URL = 'https://cors-anywhere.herokuapp.com/https://exoplanetarchive.ipac.caltech.edu/TAP/sync?query=select+distinct+top+1000+pl_name,disc_year,pl_masse,pl_rade,pl_orbper,discoverymethod,st_teff,st_rad,st_mass,disc_facility+from+ps&format=json';
...
const ExoplanetPage = () => {
    ...
    if (loading) return (
        <div className='flex flex-col justify-center items-center h-screen w-full absolute top-0'>
            <div className='flex justify-center items-center'>
                <div className="text-center text-white font-Saira text-2xl font-bold mr-2">Orbit Is Going To Space To Find New ExoPlanets </div>
    ...
    return (
        <div className="min-h-screen absolute top-0 text-white w-full">
            ...
            {/* Pagination controls */}
            <div className="flex justify-center mt-6 overflow-scroll mb-10">
