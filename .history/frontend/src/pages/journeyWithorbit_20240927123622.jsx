    ...
    return (
        <dib className="absolute top-0 h-screen w-full">
            ...
            <div className="bg-black">
                <div>
                    <img src={char2} alt="char2" className="h-96 object-cover absolute opacity-100" />
                </div>
                <div className=" flex flex-col justify-center  items-start mx-60 text-3xl text-white font-Saira h-screen">
