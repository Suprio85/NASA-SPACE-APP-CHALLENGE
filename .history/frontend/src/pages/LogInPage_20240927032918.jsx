            ...
            <div className='bg-slate-50 rounded-lg bg-opacity-10 w-1/3 h-1/2 flex flex-col justify-center items-center'>
                ...
                <div className='w-full flex  justify-center'>
                    <form className='flex flex-col items-center justify-center  w-1/2 '>
                        ...
                        <button className='btn  w-full overflow-hidden relative'>
                            <div className='z-10 text-slate-900 font-Saira text-xl'  >Log In</div>
                            <img src={planet3} alt="planet3" className="h-72 object-cover absolute " />
                        </button>
                    </form>
                </div>
                <div>
