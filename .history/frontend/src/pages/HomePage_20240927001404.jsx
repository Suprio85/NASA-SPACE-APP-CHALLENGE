...
const Hero = () => {
    return (
        <div className="hero w-full h-screen  flex items-center overflow-hidden relative z-20">
            <div className='pl-36'>
...
const ExoplanetImages = () => {
    ...
    return (
        <div className="mt-96 mx-60 z-20">
...
const HomePage = () => {
    return (
        <div className="login-page overflow-hidden bg-white ">
            <img src={_bgImage} alt="bg" className="bg absolute top-0 z-10" ></img>
            <div className=''>
                <Hero />
                <Storytelling />
                <ExoplanetImages />
