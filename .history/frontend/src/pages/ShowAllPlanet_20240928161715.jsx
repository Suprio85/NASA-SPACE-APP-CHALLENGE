...
const ExoplanetPage = () => {
    ...
    return (
        <div className="min-h-screen absolute top-0 text-white w-full">
            ...
            <div className='bg-white fixed w-20 h-20 left-20 bottom-20'>
                {
    ...
    return (
        ...
        <div className='relative group '>
            ...
            <div className='absolute w-full -bottom-4  hidden group-hover:block'>
                <div className='w-full flex justify-center'><div onClick={(planet)=>{addToPlanetList}}><Button text="Compare" /></div></div>
            </div>
        </div>
