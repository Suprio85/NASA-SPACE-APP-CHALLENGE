...
const StarCard = ({ star }) => {
    ...
    return (
        <div className="bg-gray-800 bg-opacity-0 overflow-hidden h-96 relative rounded-lg p-6 shadow-lg mb-5">
            ...
            <div className="flex items-center absolute right-10 h-fulljustify-start">
            ...
            <div className="flex ml-52 ">
                ...
                {planets.map((planet, index) => (
                    <div key={index} className='flex justify-center items-center flex-col font-Saira' style={{ marginTop: `${index * 40}px` }}>
                        <div className="mx-10 w-12 h-12 bg-blue-500 rounded-full mr-4"></div>
                        {planet.pl_name}
                    </div>
                ))}
            </div>
