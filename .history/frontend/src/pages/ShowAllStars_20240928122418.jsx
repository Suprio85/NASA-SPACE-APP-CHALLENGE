...
const StarCard = ({ star }) => {
    ...
    return (
        <div className="bg-gray-800 bg-opacity-100 overflow-hidden h-96 relative rounded-lg p-6 shadow-lg mb-5">
            <div className='absolute flex justify-center items-center top-10 left-10'>
                <div className='rounded-full bg-white w-96 h-96 absolute -z-10 flex justify-center items-center'>
                    <div className="w-full h-full bg-yellow-500 rounded-full flex justify-center items-center mb-2">
