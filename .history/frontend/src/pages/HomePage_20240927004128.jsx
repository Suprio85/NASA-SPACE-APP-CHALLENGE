...
const LatestDiscovery = () => {
    return (
        <div className='bg-slate-950 py-20 '>
            <div className='font-suse font-bold text-slate-100 text-3xl '> </div>
            <div className='w-full font-Saira text-slate-900 text-xl'>
                Check out the latest discoveries in the field of exoplanets and stay up-to-date with the latest news and research.
            </div>
        </div>
    );
}
