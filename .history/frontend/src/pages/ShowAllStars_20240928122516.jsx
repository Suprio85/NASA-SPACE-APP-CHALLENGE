    ...
    return (
        <div className="bg-gray-800 bg-opacity-0 overflow-hidden h-96 relative rounded-lg p-6 shadow-lg mb-5">
            <div className='absolute flex justify-center items-center top-10 left-10'>
                ...
                <div className='rounded-full border-white border-2  absolute opacity-50 -z-10' style={{ height: '550px ', width: '550px' }}></div>
            ...
            <div className="flex mt-4 ml-48">
                ...
                {planets.map((planet, index) => (
                    <div className='flex justify-center items-center flex-col font-Saira'>
                        <div key={index} className="mx-20 w-12 h-12 bg-blue-500 rounded-full mr-4"></div>
                        {planet.pl_name}
                    </div>
                ))}
            </div>
