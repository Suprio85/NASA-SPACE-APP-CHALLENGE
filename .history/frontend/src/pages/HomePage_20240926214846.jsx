            ...
            <div className='pl-36'>
                ...
                <div>
                    <button className='btn btn-outline overflow-hidden relative'>
                        <div className='z-10 text-slate-900 font-Saira text-xl' style="text-shadow: -2px -2px 0 #000, 2px -2px 0 #000, -2px 2px 0 #000, 2px 2px 0 #000;">Discover Now</div>
                        <img src={planet3} alt="planet3" className="-top-5 absolute w-96 ml-5" />
                    </button>
                </div>
            </div>
