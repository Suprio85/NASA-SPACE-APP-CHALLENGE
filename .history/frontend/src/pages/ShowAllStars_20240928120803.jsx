...
const StarPlanetPage = () => {
    ...
    const starsPerPage = 20; // Show 5 stars per page
    ...
    return (
        <div className="bg-gray-800 bg-opacity-35 overflow-hidden h-96 relative rounded-lg p-6 shadow-lg mb-5">
            <div className='absolute flex justify-center items-center top-10 left-10'>
                ...
                <div className='rounded-full border-white border-2  absolute -z-10' style={{height:'740px ',width:'740px'}}></div>
                <div className='rounded-full border-white border-2  absolute -z-10' style={{height:'930px ',width:'930px'}}></div>
                <div className='rounded-full border-white border-2  absolute -z-10' style={{height:'1140px ',width:'1140px'}}></div>
                <div className='rounded-full border-white border-2  absolute -z-10' style={{height:'1350px ',width:'1350px'}}></div>
