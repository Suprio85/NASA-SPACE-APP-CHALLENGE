...
// Replace with the actual NASA Exoplanet API URL
const EXOPLANET_API_URL = 'https://cors-anywhere.herokuapp.com/https://exoplanetarchive.ipac.caltech.edu/TAP/sync?query=select+pl_name,disc_year,pl_masse,pl_rade+from+ps+where+pl_kepflag=1&format=json';
