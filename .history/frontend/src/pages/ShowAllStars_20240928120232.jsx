...
const EXOPLANET_API_URL = 'https://cors-anywhere.herokuapp.com/https://exoplanetarchive.ipac.caltech.edu/TAP/sync?query=select+distinct+top+100+pl_name,pl_orbper,pl_rade,pl_masse,disc_year,discoverymethod,hostname,st_teff,st_rad,st_mass,disc_facility+from+ps&format=json';
...
const StarCard = ({ star }) => {
    ...
    return (
        <div className="bg-gray-800 bg-opacity-35 overflow-hidden h-screen relative rounded-lg p-6 shadow-lg mb-5">
            ...
            <div className="flex mt-4">
                ...
                {planets.map((planet, index) => (
                    <div key={index} className="w-12 h-12 bg-blue-500 rounded-full mr-4">{planet.pl_name}</div>
                ))}
            </div>
        </div>
    );
