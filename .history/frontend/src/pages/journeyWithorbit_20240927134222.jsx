...
const Chapter = ({ props }) => {
    return (
        <div className="mx-60 mt-60" >
            <div>
                <div className="text-3xl text-white font-Saira font-bold h-screen ">{props.title}</div>
                <div className="text-3xl text-white font-Saira font-bold h-screen ">{props.story}</div>
