...
const Storytelling = () => {
    return (
        <div>
            <div className='text-3xl text-slate-900 font-suse'>Our Story</div>
            <div className='text-xl text-slate-400 font-Saira'>We are a team of scientists, engineers, and artists who are passionate about space exploration. Our mission is to inspire the next generation of explorers by sharing the wonders of the universe.</div>
        </div>
    )
}
const HomePage = () => {
