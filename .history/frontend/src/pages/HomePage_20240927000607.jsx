...
const ExoplanetImages = () => {
    ...
    return (
        <div className="mt-96 mx-60">
            <ExoPlanetIntroduction prompt={"What Is Exoplanet ?","Exoplanets, or extrasolar planets, are planets that orbit stars beyond our solar system. Unlike the familiar planets around the Sun, exoplanets can be located light-years away, around distant stars. They come in a variety of sizes and types, including gas giants like Jupiter, rocky Earth-like planets, and even super-Earths that are larger than our home planet. Their discovery has revolutionized our understanding of the universe, raising fascinating questions about the potential for life elsewhere.","images[0].links[0].href"} /> 
            <div className='mb-5'>
            ...
            <div>
                <img src={images[0].links[0].href} alt="exoplanet" className="w-full h-96 object-cover" />
            </div>

            <div className='mb-5'>
                <Title text='Why Are Exoplanets Important?' />
                <div className='w-full font-Saira text-slate-900 text-xl'>
                    Exoplanets are important because they offer clues about how planetary systems form and evolve. Some exoplanets are found in the "habitable zone" of their stars, where conditions might support liquid water and possibly life. Studying them helps us explore the possibility of life beyond Earth and provides insight into the diversity of planets across the universe.
                </div>
            </div>
