    ...
    return (
        <div className='flex justify-center items-center h-screen '>
            ...
            <div className='bg-slate-50 rounded-lg bg-opacity-10 w-1/3 h-1/2 flex flex-col justify-center items-center'>
                ...
                <div>
                    <form className='flex flex-col items-center justify-center w-full bg-black '>
                        <input type="text" placeholder='Username' className='border-b-2 border-slate-950 bg-white bg-opacity-100 w-full my-4' />
