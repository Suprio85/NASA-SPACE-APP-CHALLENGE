...
const SmallBox = ({ label, value }) => {
    return (
        <div className='my-2 p-1 h-min-16 flex justify-center items-center flex-col bg-slate-700 rounded-md'>
            <div className='text-sm h-1/2 bg-black w-full'>{value}</div>
