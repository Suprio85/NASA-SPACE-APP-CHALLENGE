...
const EXOPLANET_API_URL = 'https://exoplanetarchive.ipac.caltech.edu/TAP/sync?query=select+distinct+pl_name,disc_year,pl_masse,pl_rade+from+ps+limit+100&format=json';
