...
const Hero = () => {
    return (
        <div className="hero w-full h-screen  flex items-center">
            <div className='text-white font-Opensans text-3xl pl-36 '>Explore the Mysteries of Exoplanets!</div>
            <div>
                <img src={planet1} alt="planet1" className="w-1/6 h-1/6 absolute" />
            </div>
        </div>
    )
}
