...
const ExoplanetCard = ({ planet }) => {
    ...
    return (
        ...
        <div className='relative group '>
            ...
            <div className='absolute w-full bg-white flex justify-center items-center hidden group-hover:block'>
                <div className='w-full flex justify-center'><Button text="Compare" /></div>
            </div>
        </div>
    </div>
