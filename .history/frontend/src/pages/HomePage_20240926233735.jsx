...
const ExoplanetImages = () => {
    ...
    // NASA API URL with your API key (replace 'DEMO_KEY' with your actual API key)
    const NASA_API_URL = 'https://images-api.nasa.gov/search?q=exoplanet';
    ...
    useEffect(() => {
      const fetchImages = async () => {
        try {
          ...
          setImages(imageItems); // Store the images in the state
      ...
      fetchImages(); // Fetch the images when component mounts
    }, []);
