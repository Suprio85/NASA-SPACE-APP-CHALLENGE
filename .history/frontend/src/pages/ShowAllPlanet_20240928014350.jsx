...
// Modify the NASA Exoplanet Archive API query to fetch only 10 results using `LIMIT 10`
const EXOPLANET_API_URL = 'https://cors-anywhere.herokuapp.com/https://exoplanetarchive.ipac.caltech.edu/TAP/sync?query=select+pl_name,disc_year,pl_masse,pl_rade+from+ps+limit+10&format=json';
...
const ExoplanetPage = () => {
    ...
    // Fetch exoplanets from NASA API (limit to 10 results)
    useEffect(() => {
        const fetchExoplanets = async () => {
            try {
                ...
                setExoplanets(data); // Fetch only 10 exoplanets
