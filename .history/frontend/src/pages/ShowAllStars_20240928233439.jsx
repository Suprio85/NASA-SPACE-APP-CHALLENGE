...
const EXOPLANET_API_URL = 'https://cors-anywhere.herokuapp.com/https://exoplanetarchive.ipac.caltech.edu/TAP/sync?query=select+distinct+top+300+pl_name,pl_orbper,pl_rade,pl_masse,disc_year,discoverymethod,hostname,st_teff,st_rad,st_mass,disc_facility+from+ps&format=json';
...
const StarPlanetPage = () => {
    ...
    const showAnimation = (stars) => {
        showAnimate ? setShowAnimate(false) : setShowAnimate(true);
        ...
        <div className="min-h-screen absolute top-0 text-white w-full ">
            ...
            <div className="w-auto mx-60 " >
                {currentStars.map((star, index) => (
                    <div onClick={()=>showAnimation(star)} className="hover:ring">
