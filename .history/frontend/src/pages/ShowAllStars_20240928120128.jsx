    ...
    return (
        <div className="bg-gray-800 bg-opacity-35 overflow-hidden h-96 relative rounded-lg p-6 shadow-lg mb-5">
            <div className='absolute flex justify-center items-center top-10 left-10'>
                ...
                <div className='rounded-full border-white border-2  absolute ' style={{height:'550px ',width:'550px'}}></div>
                <div className='rounded-full border-white border-2  absolute ' style={{height:'730px ',width:'730px'}}></div>
                <div className='rounded-full border-white border-2  absolute ' style={{height:'910px ',width:'910px'}}></div>
                <div className='rounded-full border-white border-2  absolute ' style={{height:'1100px ',width:'1100px'}}></div>
                <div className='rounded-full border-white border-2  absolute ' style={{height:'1300px ',width:'1300px'}}></div>
                <div className='rounded-full border-white border-2  absolute ' style={{height:'1500px ',width:'1500px'}}></div>
                <div className='rounded-full border-white border-2  absolute ' style={{height:'1700px ',width:'1700px'}}></div>
            </div>
