...
const Hero = () => {
    return (
        <div className="hero w-full h-screen  flex items-center overflow-hidden">
            <div className='text-white font-suse text-3xl pl-36 '>Explore the Mysteries of Exoplanets!</div>
            <div>
                <img src={planet1} alt="planet1" className=" top-20 w-1/3 -right-24" />
                <img src={planet2} alt="planet2" className="absolute top-60 w-1/3 right-48" />
            </div>
        </div>
    )
}
