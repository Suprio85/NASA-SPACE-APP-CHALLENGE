...
const ExoplanetPage = () => {
    ...
    return (
        <div className="min-h-screen absolute top-0 text-white w-full">
            ...
            <div className=' fixed  w-96 bg-white h-screen top-0 left-0 '>
                {
                    planetList.map((planet, index) => (
                        <div key={index} className='flex relative justify-center items-start'>
                            <div className='absolute right-1 top-1' onClick={()=>removeFromPlanetList(planet)}>
