...
const ExoplanetPage = () => {
    ...
    return (
        <div className="min-h-screen absolute top-0 text-white w-full">
            ...
            {planetList.length > 0 &&
                <div className=' fixed   w-60  h-screen top-0 left-0 '>
                    <div className='h-full bg-slate-950 bg-opacity-40 rounded-e-full flex flex-col justify-center items-center'>
                        {
