    ...
    return (
        <div className="hero w-full h-screen  flex items-center overflow-hidden relative">
            <div>
                ...
                <div className='text-slate-400 font-Saira text-xl pl-36 w-1/2'>
            ...
            <button class="relative px-6 py-3 font-bold text-white rounded-full transition-transform transform hover:scale-105"
        style="background: radial-gradient(circle at 30% 30%, #4b6cb7, #182848);">
  Explore Now
</button>
