    ...
    return (
        <div className="min-h-screen absolute top-0 text-white w-full ">
            ...
            <div>
                <Chapter
                    title="Star Explorer"
                    story="Orbit floated quietly in space, his sensors scanning the vast universe around him. The stars twinkled like diamonds scattered across the night sky, but Orbit had his eyes on something bigger—entire solar systems beyond our own.

                    “We all know about our solar system,” Orbit began with a glowing smile, “but did you know that there are millions of star systems out there, each with their own planets, moons, and mysteries? Some of these star systems are incredibly different from ours, and some are surprisingly similar!”

                    Orbit gestured toward the dark expanse.

                    “Today, I’m going to take you on a journey to explore some of these distant solar systems. Some have multiple stars, others have strange planets orbiting in unusual ways, and a few might even have planets where life could exist.”"
                    image={char1} 
                    dir="rtl" />
            </div>

            <h1 className="text-4xl font-bold text-center mb-8">Star Explorer</h1>
