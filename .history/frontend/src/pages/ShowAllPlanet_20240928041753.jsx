...
const SmallBox = ({ label, value }) => {
    return (
        <div className='my-2  h-min-16 flex justify-center items-center flex-col bg-slate-700 rounded-md'>
            <div className='text-sm h-2/3 bg-black w-full flex justify-center items-center'>{value}</div>
            <div className='font-bold h-1/2'>{label}</div>
        </div>
    );
};
