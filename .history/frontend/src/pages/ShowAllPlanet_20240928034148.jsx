...
const ExoplanetPage = () => {
    ...
    return (
        <div className="min-h-screen absolute top-0 text-white w-full">
            <div className="flex items-center w-full fixed -z-10">
...
const ExoplanetCard = ({ planet }) => {
    ...
    useEffect(() => {
        const fetchPlanetImage = async () => {
            try {
                // If the planet's name is too specific, it can cause issues. 
                // Try using the first part of the planet name or fallback.
    ...
    return (
        <div className="bg-gray-800 overflow-hidden relative rounded-lg p-6 shadow-lg">
            <div className='absolute overflow-hidden -right-20 -top-20'>
                <img src={planet7} alt="Planet" className="w-full object-cover rounded-lg mb-4 -z-10" style={{ height: '500px' }} />
            </div>
            <div className='z-10'>
