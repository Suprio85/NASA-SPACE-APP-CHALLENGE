...
const StarCard = ({ star }) => {
    ...
    return (
        <div className="bg-gray-800 overflow-hidden relative rounded-lg p-6 shadow-lg mb-5">
            <div className='absolute flex justify-center items-center -top-20 -left-20'>
                <div className='rounded-full bg-white w-80 h-80 absolute '>

                </div>
                <div className='rounded-full border-white border-2 w-96 h-96 absolute -top-20 -left-20'>
