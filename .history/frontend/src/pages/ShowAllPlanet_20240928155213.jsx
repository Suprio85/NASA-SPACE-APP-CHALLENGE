...
const ExoplanetCard = ({ planet }) => {
    ...
    return (
        <div className="bg-gray-800 relative overflow-hidden rounded-lg p-6 shadow-lg mb-5">
        <div className='absolute overflow-hidden right-5 top-5 opacity-50'>
            <img src={planet7} alt="Decorative Planet Image" className="object-cover rounded-lg" style={{ height: '500px' }} />
        </div>
        <div className='absolute overflow-hidden left-5 bottom-5 opacity-70'>
        ...
        <div className='relative group'>
            <div className='flex items-center'>
                <div className='w-1/2'>
                    ...
                    <div className='grid grid-cols-3 gap-2 mr-10'>
                ...
                <div className='w-1/2'>
                    <img src={imageUrl} alt={planet.pl_name} className="w-full h-80 object-cover rounded-lg" />
                </div>
            </div>
