...
const ExoplanetCard = ({ planet }) => {
    ...
    return (
        <div className="bg-gray-800 overflow-hidden relative rounded-lg p-6 shadow-lg -z-10 mb-5">
            ...
            <div className='relative group z-30'>  {/* Ensure this div is relative to position the button correctly */}
                ...
                <div className='absolute bottom-5 right-20 hidden group-hover:block'> {/* Button is now inside the relative parent */}
