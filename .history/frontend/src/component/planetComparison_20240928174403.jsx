...
const divShowing = ({ mass, radius, orbitalPeriod, DiscoveryYear, discoverymethod, HostStarTemp, HostStarRasius, HostStarMass, disc_facility }) => {
    return (
        <div>
            <div className='bg-black'>{mass}</div>
        </div>
    )
