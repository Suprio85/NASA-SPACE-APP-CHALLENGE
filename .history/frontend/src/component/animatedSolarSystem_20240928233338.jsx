...
const SolarSystem = ({planets}) => {
    ...
    return (
        <div className="flex fixed justify-center items-center h-screen   top-0 left-0 w-full">
                    ...
                    <div>
                        <div
                            ...
                            style={{
                                ...
                                top: `calc(50% - ${(index + 1) * 50}px)`,
                                left: `calc(50% - ${(index + 1) * 50}px)`,
                                animation: `spin ${index * 10}s linear infinite`,
                        ...
                        <div className=' bg-slate-500 bg-opacity-5  rounded-full absolute'
                            style={{
                                width: `${(index + 1) * 130}px`,
                                height: `${(index + 1) * 130}px`,
                                top: `calc(50% - ${(index + 1) * 65}px)`,
                                left: `calc(50% - ${(index + 1) * 65}px)`,
                            }}>
                        </div>
                    </div>
                ))}
