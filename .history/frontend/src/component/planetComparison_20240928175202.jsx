                ...
                <div className="flex justify-evenly gap-3 mx-3">
                    {planetList.map((planet, index) => (
                        <div key={index} className="bg-gray-900 p-3 rounded-lg">
                            ...
                            <DivShowing text={planet.pl_orbper} />
                            <DivShowing text={planet.pl_dens} />
                            <DivShowing text={planet.pl_eqt} />
                            <DivShowing text={planet.pl_disc} />
                            <DivShowing text={planet.pl_facility} />
                            <DivShowing text={planet.pl_telescope} />
                            <DivShowing text={planet.pl_instrument} />
                            <DivShowing text={planet.pl_status} />
                            <DivShowing text={planet.pl_pelink} />
                            <DivShowing text={planet.pl_edelink} />
                            <DivShowing text={planet.pl_publ_date} />
                            <DivShowing text={planet.pl_locale} />
