            ...
            <div className="relative">
                ...
                {planets.map((planet, index) => (
                    <div>
                        ...
                        style={{
                            width: `${(planet.planetIndex + 1.5) * 100}px`,
                            height: `${(planet.planetIndex + 1.5) * 100}px`,
                            top: `calc(50% - ${(planet.planetIndex + 1.5) * 50}px)`,
                            left: `calc(50% - ${(planet.planetIndex + 1.5) * 50}px)`,
