...
const DivShowing = ({ value }) => {
    return (
        <div className={`bg-slate-800 ${bold ==="y" ? "bg-opacity-50":"bg-opacity-90"} rounded m-2 flex justify-center items-center font-Saira h-16 text-white`} >
            {value || "Unknown"}
        </div>
    );
};

const PlanetComparison = ({ planetList ,bold}) => {
    ...
    return (
        <div className="bg-slate-950 bg-opacity-90 h-screen w-full flex justify-center items-center">
            ...
            <div className='bg-slate-950 w-2/3 h-full pt-10 flex '>
