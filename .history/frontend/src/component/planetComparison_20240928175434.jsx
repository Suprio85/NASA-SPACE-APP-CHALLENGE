        ...
        <div className="bg-slate-950 bg-opacity-90  h-screen w-full flex justify-center items-center">
            <div className='bg-slate-950 w-2/3 h-full pt-10'>
                ...
                <div className="flex justify-evenly gap-3 mx-3">
                    <div className='flex'>
                    <DivShowing text="Mass" />
                    <DivShowing text="Radius" />
                    <DivShowing text="Orbital Period" />
                    <DivShowing text="Discovery Year" />
                    <DivShowing text="Discovery Method" />
                    <DivShowing text="Host Star" />
                    <DivShowing text="Host Star Temperature" />
                    <DivShowing text="Host Star Radius" />
                    <DivShowing text="Host Star Mass" />
                    <DivShowing text="Discovery Dacility" />   
                    </div>                
