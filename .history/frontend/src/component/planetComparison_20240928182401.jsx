...
const PlanetComparison = ({ planetList }) => {
    if (planetList.length < 2) {
        return <div className="text-white text-center absolute h-screen flex justify-normal items-center mt-24 ml-3 z-50  font-Saira font-bold">Add more planets to compare.</div>;
    }
