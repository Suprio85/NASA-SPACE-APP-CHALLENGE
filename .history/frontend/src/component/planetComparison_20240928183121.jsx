...
const DivShowing = ({ value, bold }) => {
    return (
        <div className={`bg-slate-800 ${bold === "y" ? "bg-opacity-100 font-bold" : "bg-opacity-50"} rounded m-1 flex justify-center items-center font-Saira h-16 text-white`} >
            {value || "Unknown"}
        </div>
    );
};

const PlanetComparison = ({ planetList ,toggle}) => {
    ...
    return (
        <div className="bg-slate-950 bg-opacity-90 h-screen w-full flex flex-col justify-center items-center">
            <div className='bg-slate-950 w-2/3 relative pb-3 pt-10 flex flex-col ring m-4 mb-5'>
                <div className="absolute top-0 right-0  m-5" onClick={}>
                ...
                <div className="w-full flex  justify-center">
                    <div className='flex min-w-60 flex-col'>
                        ...
                        <DivShowing value="Mass" bold="y"/>
                        <DivShowing value="Radius" bold="y"/>
                        <DivShowing value="Orbital Period" bold="y"/>
                        <DivShowing value="Discovery Year" bold="y"/>
                        <DivShowing value="Discovery Method" bold="y"/>
                        <DivShowing value="Host Star Temperature" bold="y"/>
                        <DivShowing value="Host Star Radius" bold="y"/>
                        <DivShowing value="Host Star Mass" bold="y"/>
                        <DivShowing value="Discovery Facility" bold="y"/>
                    </div>
