...
const SolarSystem = ({ planets, showAnimation }) => {
    ...
    return (
        <div className="flex fixed justify-center items-center h-screen   top-0 left-0 w-full bg-slate-900 z-40">
            ...
            <div className='fixed bottom-10 w-full  z-50'>
                <div className='w-full flex justify-center  items-center'>
                    <div className='rounded-full bg-slate-700 w-10 h-10 flex justify-center items-center'>
                        <button onClick={showAnimation}>
                            <FontAwesomeIcon icon={faXmark} className="text-white cursor-pointer " size='2xl' />
                        </button>
                    </div>
                </div>
            </div>
