...
const SolarSystem = () => {
    const planets = [
        { name: "Mercury", planetIndex:2, speed: "10s", offsetAngle: 0 },
        ...
        { name: "Mercury", planetIndex:5, speed: "20s", offsetAngle: 0 },
        { name: "Mercury", planetIndex:6, speed: "20s", offsetAngle: 0 },
        { name: "Mercury", planetIndex:7, speed: "20s", offsetAngle: 0 },
