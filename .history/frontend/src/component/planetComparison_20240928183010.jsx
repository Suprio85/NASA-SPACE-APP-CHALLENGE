...
const DivShowing = ({ value, bold }) => {
    return (
        <div className={`bg-slate-800 ${bold === "y" ? "bg-opacity-100 font-bold" : "bg-opacity-50"} rounded m-1 mb-2flex justify-center items-center font-Saira h-16 text-white`} >
            {value || "Unknown"}
        </div>
    );
};
...
const PlanetComparison = ({ planetList }) => {
    ...
    return (
        <div className="bg-slate-950 bg-opacity-90 h-screen w-full flex flex-col justify-center items-center">
            <div className='bg-slate-950 w-2/3 relative  pt-10 flex flex-col ring m-4 mb-5'>
