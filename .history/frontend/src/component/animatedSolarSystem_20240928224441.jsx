                ...
                {planets.map((planet, index) => (
                    <div>
                        <div
                            ...
                            <div
                                className="absolute bg-white text-3xl h-10 w-10 rounded-full"
                            ><img src={planetImages[planet.planetIndex]}></img></div>
                        </div>
                        <div className='ring rounded-full absolute' 
                        style={{
                            width: `${(planet.planetIndex + 1) * 100+20}px`,
                            height: `${(planet.planetIndex + 1) * 100+20}px`,
                            top: `calc(50% - ${(planet.planetIndex + 1) * 50 +20}px)`,
                            left: `calc(50% - ${(planet.planetIndex + 1) * 50 + 20}px)`,
